...
public class CardController {
   ...
   // @GetMapping("/cards")
    ...
    @GetMapping("/cards")
    public List<ResponseCard> getCards(@RequestParam (name = "l", required = false, defaultValue = "")String language,
                                       ...
                                       @RequestParam (name = "g", required = false, defaultValue = "")String groupslanguage
                                       ){
        return service.getCards(language,word,example,translateLanguage,translation,groupslanguage);
